...
class AneurysmDataset(Dataset):
    ...
    def __init__(
        ...
        self.extensions = {"dicom": [".dcm", ".dicom"], "png": [".png"], "jpg": [".jpg", ".jpeg"], "npy": [".npy"]}
...
class MultiViewDataset(AneurysmDataset):
    ...
    def __init__(
        self, df: pd.DataFrame, image_dir: Union[str, Path], views_per_sample: int = 3, view_column: str = "view_id", **kwargs
    ):
        """
        Args:
