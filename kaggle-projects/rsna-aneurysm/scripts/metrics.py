...
class MetricsCalculator:
    ...
    def plot_precision_recall_curve(
        self, title: str = "Precision-Recall Curve", figsize: Tuple[int, int] = (8, 6)
    ) -> plt.Figure:
    ...
    def plot_calibration_curve(
        self, n_bins: int = 10, title: str = "Calibration Curve", figsize: Tuple[int, int] = (8, 6)
    ) -> plt.Figure:
    ...
    def plot_prediction_distribution(
        self, title: str = "Prediction Distribution", figsize: Tuple[int, int] = (10, 6)
    ) -> plt.Figure:
...
def bootstrap_metrics(
    y_true: np.ndarray, y_pred: np.ndarray, n_bootstrap: int = 1000, confidence_level: float = 0.95, random_state: int = 42
    ...
    bootstrap_scores = {"roc_auc": [], "avg_precision": [], "accuracy": [], "f1": []}
