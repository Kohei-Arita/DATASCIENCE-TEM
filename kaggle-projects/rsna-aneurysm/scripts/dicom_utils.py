...
class DICOMProcessor:
    ...
    def batch_process(self, dicom_paths: List[Union[str, Path]], 
                     output_dir: Optional[Union[str, Path]] = None,
                     save_format: str = 'png') -> List[Dict[str, Any]]:
        """
...
class DICOMMetadataExtractor:
    ...
    def __init__(self):
        self.metadata_fields = [
            ...
            'PatientAge', 'PatientSex', 'StudyDate', 'StudyTime',
...
def convert_dicom_to_image(
    ...
    processor = DICOMProcessor(
        default_window_center=window_center,
